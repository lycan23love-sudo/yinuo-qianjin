          ...
          <div style={{ paddingBottom:90, background:'#FAF7F2', minHeight:'100vh' }}>
                    ...
                    <div style={{ padding:'0 16px' }}>
                                <div style={S.headerCard}>
                                          ...
                                          <div style={{ borderTop:'0.5px solid rgba(255,255,255,.1)', paddingTop:10,
                                                      ...
                                                      <div style={{ display:'flex', alignItems:'center', gap:6 }}>
                                                                    ...
                                                                    <div style={{ display:'flex', alignItems:'center', gap:4 }}>
                                                                        {Array.from({ length: limit }).map((_, i) => (
                                                                                <span key={i} style={{ display:'inline-block', width:30, height:9, borderRadius:5,
                                                                                                                          background: i < active.length ? '#C8922A' : i < used ? 'rgba(200,64,64,.7)' : 'rgba(255,255,255,.15)' }} />
                                                                              ))}
                                                                    </div>
                                                      </div>
                                                      <div style={{ display:'flex', alignItems:'center', gap:4 }}>
                                                    ...
                                                    return (
                                                                    <div style={S.heroCard} onClick={() => nav(`/pledge/${topPledge.id}`)}>
                                                                                  ...
                                                                                  <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:14 }}>
                                                                                                  <div style={{ fontFamily:'Noto Serif SC,serif', fontSize:15, fontWeight:700, color:'#E8B84A' }}>
                                                                                  ...
                                                                                  <div style={{ display:'flex', alignItems:'center', gap:10 }}>
                                                                                                  ...
                                                                                                  <div style={{ flex:1, minWidth:0 }}>
                                                                                                                    <div style={{ fontSize:13, fontWeight:600, fontFamily:'Noto Serif SC,serif',
                                                                                                                                                     overflow:'hidden', textOverflow:'ellipsis', whiteSpace:'nowrap' }}>{p.title}
