...
export default function HomePage() {
  ...
  return (
            <div style={{ paddingBottom: 'calc(90px + env(safe-area-inset-bottom))', background: '#FAF7F2', minHeight: '100vh' }}>
...
const S = {
        topbar: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: 'calc(12px + env(safe-area-inset-top)) 16px 12px', position: 'sticky', top: 0, background: '#FAF7F2', zIndex: 10, borderBottom: '0.5px solid #E0D5C0' },
